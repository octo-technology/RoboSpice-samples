...
public class TweeterJsonGoogleHttpClientSpiceActivity extends BaseActivity {
    ...
    protected void onStart() {
        ...
        spiceManager.getFromCache(ListTweets.class, JSON_CACHE_KEY, DurationInMillis.ALWAYS_RETURNED, new TweetRequestListener());
    }
    ...
    public void startDemo() {
        ...
        spiceManager.execute(tweetJsonGoogleHttpClientRequest, JSON_CACHE_KEY, DurationInMillis.ALWAYS_EXPIRED, new TweetRequestListener());
    }
