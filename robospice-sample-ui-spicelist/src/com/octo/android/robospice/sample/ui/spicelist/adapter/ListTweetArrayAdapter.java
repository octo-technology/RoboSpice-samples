...
public class ListTweetArrayAdapter extends SpiceArrayAdapter<Tweet> {
    ...
    public ListTweetArrayAdapter(Context context, BitmapSpiceManager spiceManagerBitmap, ListTweets tweets) {
    ...
    public BitmapRequest createRequest(Tweet tweet, int requestImageWidth, int requestImageHeight) {
        ...
        return new BitmapRequest(tweet.getProfile_image_url(), requestImageWidth, requestImageHeight, tempFile);
    }

    @Override
    public SpiceListItemView<Tweet> createView(Context context) {
